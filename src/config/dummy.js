...
const products = [
  ...
  },
  {
    id: 4,
    title: "OPPO F19",
    description: "OPPO F19 is officially announced on April 2022.",
    price: 280,
  ...
  },
  {
    ...
    title: "MacBook Pro",
    description:
      "MacBook Pro 2022 with mini-LED display may launch between September, November",
    price: 1749,
    ...
    discountedTotal:
      Math.round(
        orders[i].products
          .map(
            (e) =>
              products[e.id - 1].price *
              (100.0 - products[e.id - 1].discountPercentage)
          )
          .reduce((prev, curr) => prev + curr, 0)
      ) / 100.0,
    totalProducts: orders[i].products.length,
    totalQuantity: orders[i].totalQuantity,
  });
}
...
const dummy = {
  ...
  editorData:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque hendrerit orci et tortor lobortis, a aliquam nisl semper. Nullam magna lectus, efficitur sit amet mauris nec, imperdiet hendrerit augue. Proin id enim non nunc consectetur molestie. Cras faucibus odio mattis, pulvinar arcu sed, fermentum libero. Pellentesque orci sem, pharetra sit amet sodales eget, ullamcorper a urna. Donec vitae euismod sapien. Sed vehicula in lectus vitae congue. Aenean facilisis maximus diam et molestie. Aliquam erat volutpat. Donec pellentesque justo eu tempor lobortis. Duis sed quam ultrices, rhoncus eros sed, interdum libero. Proin diam magna, auctor quis iaculis a, tincidunt ut eros. Nam iaculis odio eget elit hendrerit accumsan. Pellentesque id ullamcorper risus. Integer sodales porttitor nibh, quis elementum tellus dictum quis.Vestibulum rutrum neque at erat vulputate blandit. Nulla nec dapibus nunc, in pellentesque quam. Integer tempor, nibh volutpat aliquam pretium, tellus tortor cursus felis, vitae pharetra massa quam dignissim eros. Donec iaculis ultricies nibh laoreet ultricies. Vivamus non nisi ut ligula gravida lobortis. Quisque a sapien massa. Quisque mattis, mauris ut maximus iaculis, risus tellus ultricies justo, sit amet egestas metus lectus ac purus. Ut dictum magna ullamcorper ipsum faucibus, non iaculis elit hendrerit. Etiam rutrum dui metus, a pharetra quam aliquam in. Sed ut ullamcorper velit. Proin vitae malesuada felis. Morbi ac imperdiet nibh. Donec sapien quam, ullamcorper non diam aliquam, gravida imperdiet orci. Curabitur lorem augue, fermentum in dignissim sed, pellentesque ut arcu. Vestibulum interdum urna eget laoreet auctor. Nullam et iaculis ligula, sed convallis ligula. Pellentesque augue magna, pellentesque rutrum libero non, accumsan placerat ipsum. Nulla non massa in enim tincidunt euismod ut quis tellus. Maecenas bibendum eros ac libero sodales, vitae venenatis nunc vulputate. In rhoncus augue eu nisl mattis, vel feugiat nunc porttitor. Cras at nulla a sapien euismod vehicula. Donec sed massa ut nunc dapibus luctus vel et diam. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nam rutrum sapien vitae massa posuere, quis bibendum odio varius. Nunc blandit elementum odio vel interdum. Ut varius ipsum justo, id volutpat est viverra eu. Duis nec lorem pretium, mollis turpis at, aliquam dolor. Aliquam erat volutpat. Praesent vitae ultrices mi. Aenean aliquet, risus vestibulum semper luctus, est massa ultrices est, ut elementum mauris eros eget ligula. In egestas ligula ex, eget aliquam dui placerat in. Aliquam elementum tempus lorem at varius. Quisque blandit laoreet nulla vel pretium. Morbi hendrerit viverra laoreet. Proin sagittis nisi tellus, sit amet posuere justo interdum vel. Nam tristique volutpat tempor. Duis eu malesuada enim. Nunc quam nisl, pulvinar sed felis viverra, viverra sagittis mi. Fusce vestibulum sapien a cursus consequat. Quisque vulputate magna sit amet consequat sodales. Fusce quis tincidunt neque. Praesent velit lacus, commodo ut nunc in, sollicitudin faucibus tellus. In in accumsan urna.",
};
